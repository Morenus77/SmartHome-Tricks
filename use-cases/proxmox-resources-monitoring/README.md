...
![preview](./proxmox-resources-monitoring.webp)
...
Import the flow into Node-RED using the [Proxmox resources monitoring](/download/Proxmox_resources_monitoring.json) JSON provided.
...
![mqttexplorer-sensors](mqttexplorer-sensors.webp)
...
![mqttexplorer-config](mqttexplorer-config.webp)
...
![HA Dashboard](ha-dashboard.webp)

![HA Popup](ha-popup.webp)
