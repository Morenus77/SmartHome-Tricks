---
title: 'Proxmox resources monitoring'
visible: false
date: '14-12-2024 17:29'
media_order: 'Proxmox_resources_monitoring.json,ha-popup.webp,ha-dashboard.webp,ha-device.webp,mqttexplorer-config.webp,mqttexplorer-sensors.webp,nodered_flow.webp'
taxonomy:
    tag: [Proxmox VE, home assistant, Node-RED, MQTT, MQTT Discovery, REST API, Javascript]
image_url: https://smarthometricks.sirri.it/user/pages/01.home/_use-cases/proxmox-resources-monitoring/preview.webp
metadata:
  'og:title': Proxmox resources monitoring
  'og:type': article
  'og:image': https://smarthometricks.sirri.it/user/pages/01.home/_use-cases/proxmox-resources-monitoring/preview.webp
  'og:url': https://smarthometricks.sirri.it/home/_use-cases/proxmox-resources-monitoring
  description: his process allows to expose in Home Assistant (or other Smart Home Hub) all information about all LXC and VMs defined in a Proxmox VE node.
---
...
![HA Device](ha-device.webp?cropResize=600)
...
![Node-RED Flow](nodered_flow.webp)
...
3. **Data Transformation**:
   ...
   - It also adds some attributes not provided by the API:
     ...
     - `lastbackup`: a marker for the last succesfully backup date; It's is not provided by this trick but from the [Expose the date of Proxmox and Synology backups in Home Assistant](../proxmox-synology-backup) one. You can remove it if not interested, but If you want it, you have to define It here even if not provided as sensor value, because this transformation node is also used by the **MQTT Discovery** configuration part.
...
![mqttexplorer-sensors](mqttexplorer-sensors.webp?cropResize=800)
...
![mqttexplorer-config](mqttexplorer-config.webp?cropResize=800)

and in Home Assistant would appear the device with all it's sensor under **MQTT integration**. 

![HA Device](ha-device.webp?cropResize=500)
...
![HA Dashboard](ha-dashboard.webp?cropResize=600)
![HA Popup](ha-popup.webp?cropResize=400)
