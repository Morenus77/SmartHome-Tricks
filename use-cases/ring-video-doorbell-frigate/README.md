---
title: 'Ring Video Doorbell Frigate'
date: '03-12-2024 22:25'
media_order: 'restream switch.webp,restream.webp'
taxonomy:
    tag: [Frigate, home assistant, Scrypted, REST API]
image_url: https://smarthometricks.sirri.it/user/pages/01.home/_use-cases/ring-video-doorbell-frigate/preview.webp
metadata:
  'og:title': Connect a Ring Video Doorbell camera in Frigate
  'og:type': article
  'og:image': https://smarthometricks.sirri.it/user/pages/01.home/_use-cases/ring-video-doorbell-frigate/preview.webp
  'og:url': https://smarthometricks.sirri.it/home/_use-cases/ring-video-doorbell-frigate
  description: This process allows managing a Ring Video Doorbell (or another battery-powered camera) in Frigate or other NVR software that relies on continuous recording, without the risk of draining the battery.
---
...
![restream-switch](restream%20switch.webp)
