---
title: 'Proxmox and Synology Backup status'
date: '30-11-2024 15:32'
media_order: 'Gotify_Backup_Notifications.json,lovelace-info.webp,lovelace-chi.webpg,lovelace-actio.webpg,mqtt_explorer.webp,nodered_flow.webp,synology_webhook.webp,gotify_config.webp,config_proxmox_backup_job.webp'
taxonomy:
    tag: [Proxmox VE, home assistant, Template sensor, lovelace, Synology DSM, MQTT, Node-RED, Gotify, REST API, Javascript]
image_url: https://smarthometricks.sirri.it/user/pages/01.home/_use-cases/proxmox-synology-backup/preview.webp
metadata:
  'og:title': Proxmox and Synology Backup status
  'og:type': article
  'og:image': https://smarthometricks.sirri.it/user/pages/01.home/_use-cases/proxmox-synology-backup/preview.webpp
  'og:url': https://smarthometricks.sirri.it/home/_use-cases/proxmox-synology-backup
  description: This workflow exposes to Home Assistant the backup status (last successfull backup date) of Proxmox VE, Synology Active Backup for Business and Synology Hyper Backup.
---
...
![Backup Config](config_proxmox_backup_job.webp)
...
![lovelace-chip](lovelace-chip.webp)
![lovelace-info](lovelace-info.webp)
...
![lovelace-action](lovelace-action.webp)
